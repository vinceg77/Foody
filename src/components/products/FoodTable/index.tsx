...
import { Search, ArrowUpDown, Trash2, AlertCircle, Plus, ExternalLink, Edit2, Check, Filter } from "lucide-react";
...
export const FoodTable: React.FC = () => {
  ...
  const filteredFoods = sortedFoods.filter(
    (food) =>
      (showConsumed ? food.consumed : !food.consumed) &&
  ...
  const handleSaveEdit = async (updatedFood: FoodItem) => {
    try {
  ...
  const handleMarkConsumed = async (food: FoodItem) => {
    try {
      const updatedFood = {
        ...food,
        consumed: true,
      ...
      await updateFoodItem(food.id!, updatedFood);
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                {showConsumed ? "Voir les produits actifs" : "Voir les produits consommés"}
              </button>
              <button
                      ...
                      <div className="flex items-center space-x-3">
                        {!food.consumed && (
                          <>
                            ...
                            <button
                              onClick={() => handleMarkConsumed(food)}
                        ...
                        <button
                          onClick={() => handleRemoveItem(food.id!, food.quantity)}
